...
//		driver.get("https://www.phot.ai/");
	...
	@Test(priority = 3 )
	public void ExistingCreditBalance() throws InterruptedException {
...
//		 WebElement uploadbutton=driver.findElement(By.xpath("//img[@alt='6682e51f462b3354f338582f-sample']"));
		...
		try {
			...
			Assert.fail("Generate button is not displayed");
	...
	void creditBalanceAfterToolUse() throws InterruptedException {
